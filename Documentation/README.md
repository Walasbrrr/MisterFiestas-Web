...
**Producto:** la web **recolecta información** → **mensaje WhatsApp prellenado** (`wa.me`, gratis)  
**Dominio:** [misterfiestas.com](https://misterfiestas.com)

**Para Walen — vista del equipo:** [Responsibilities.md](03-Team/Responsibilities.md)
...
- [Roadmap por fases](00-Project/Git-Workflow.md) — tareas por persona

### Producto

- [**Asistente web → WhatsApp**](01-Product/WhatsApp-Assistant.md) — campos, plantilla, estado
...
- [**Responsabilidades y seguimiento**](03-Team/Responsibilities.md) — matriz RACI, entregables
- [Perfiles](03-Team/Team.md)
