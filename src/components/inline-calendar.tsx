    ...
    <div className="inline-calendar-layout">
      ...
      <div className="inline-calendar-card">
        ...
        <div className="calendar-grid">
          {DAYS_ES.map((d) => (
            <div key={d} className="calendar-day-header calendar-day-header-dark">
              {d}
            </div>
          ))}
          {calendarDays.map((day, i) => {
            ...
            const partiallyBooked = isDatePartiallyBooked(viewYear, viewMonth, day);
            const isToday =
              viewYear === currentYear &&
      ...
      <div className="inline-calendar-sidebar">
              ...
              {hoveredInfo.fullyBooked ? (
                <div className="hover-card-status hover-card-status-booked">
                  ...
                  <div>
                    ...
                    <span>Todos los horarios están reservados para este día</span>
                  </div>
                </div>
              ) : (
        ...
        {/* CTA */}
        <button
          className="button inline-calendar-cta"
